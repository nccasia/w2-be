...
import { ProjectSettingsAvgAggregateInput } from '../project-settings/project-settings-avg-aggregate.input';
import { ProjectSettingsSumAggregateInput } from '../project-settings/project-settings-sum-aggregate.input';
...
export class ProjectSettingsAggregateArgs {
    ...
    @Field(() => ProjectSettingsAvgAggregateInput, {nullable:true})
    _avg?: ProjectSettingsAvgAggregateInput;

    @Field(() => ProjectSettingsSumAggregateInput, {nullable:true})
    _sum?: ProjectSettingsSumAggregateInput;
