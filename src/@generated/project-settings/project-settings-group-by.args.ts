...
import { ProjectSettingsAvgAggregateInput } from './project-settings-avg-aggregate.input';
import { ProjectSettingsSumAggregateInput } from './project-settings-sum-aggregate.input';
