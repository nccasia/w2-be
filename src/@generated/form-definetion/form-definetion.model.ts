...
import { FormDefinetionCount } from './form-definetion-count.output';

@ObjectType()
export class FormDefinetion {
    ...
    @Field(() => FormDefinetionCount, {nullable:false})
    _count?: FormDefinetionCount;
}
