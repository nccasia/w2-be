...
import { NestedEnumTriggerStatusWithAggregatesFilter } from './nested-enum-trigger-status-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumTriggerStatusFilter } from './nested-enum-trigger-status-filter.input';

@InputType()
export class EnumTriggerStatusWithAggregatesFilter {
