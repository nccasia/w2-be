...
import { NestedEnumTaskBoardTypeWithAggregatesFilter } from './nested-enum-task-board-type-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumTaskBoardTypeFilter } from './nested-enum-task-board-type-filter.input';

@InputType()
export class EnumTaskBoardTypeWithAggregatesFilter {
