...
import { TaskBoardSettingsUncheckedCreateNestedManyWithoutTaskBoardInput } from '../task-board-settings/task-board-settings-unchecked-create-nested-many-without-task-board.input';

@InputType()
export class TaskBoardUncheckedCreateWithoutTaskDefinitionInput {
