...
ALTER TABLE ONLY public."TaskDefinition"
    ADD CONSTRAINT "TaskDefinition_formId_fkey" FOREIGN KEY ("formId") REFERENCES public."Form"(id) ON UPDATE CASCADE ON DELETE SET NULL;
ALTER TABLE ONLY public."TaskDefinition"
    ADD CONSTRAINT "TaskDefinition_organizationId_fkey" FOREIGN KEY ("organizationId") REFERENCES public."Organization"(id) ON UPDATE CASCADE ON DELETE RESTRICT;
ALTER TABLE ONLY public."TaskDefinition"
